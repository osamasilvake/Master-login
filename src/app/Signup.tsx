...
const Signup = () => (
	<div className="flex flex-col justify-center items-center pt-20 md:items-stretch  md:flex-row">
		<div className="bg-white flex w-96">
			<form className="flex flex-col py-16 mx-auto">
				<h2 className="text-center pb-5 text-3xl">Sign up</h2>
				<p className="text-center pb-6">Enter your credentials to signup</p>
				<input type="text" placeholder="username" className="rounded-md outline-none px-2 py-1 bg-slate-100" />
				<input
					type="password"
					placeholder="password"
					className="mt-4 rounded-md outline-none px-2 border-0 py-1 bg-slate-100"
				/>
